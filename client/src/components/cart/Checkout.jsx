        ...
        cart.cartItems.map((item) => ( 
          <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
            <div className="flex flex-col rounded-lg bg-white sm:flex-row">
              <img className="m-2 h-24 w-28 rounded-md border object-cover object-center" src={item.product_images[0]} alt={item.product_name} />
              <div className="flex w-full flex-col px-4 py-4">
                <span className="font-semibold">{item.product_name}</span>
                <span className="float-right text-gray-400">{item.short_description}</span>
                <span className="font-semibold">Quantity: {item.cartQuantity}</span>
                <p className="text-lg font-bold">Total: ${item.price * item.cartQuantity}</p>
              </div>
            </div>
          </div>
      ...
      <div className="">
        ...
        <div className="flex flex-col sm:flex-row">
          <div className="relative flex-shrink-0 sm:w-7/12">
            ...
            <div className="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
              <img className="h-4 w-4 object-contain" src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/50/Royal_Flag_of_Morocco.svg/2560px-Royal_Flag_of_Morocco.svg.png" alt="" />
            </div>
          </div>
        ...
        <div className="mt-6 border-t border-b py-2">
          <div className="flex items-center justify-between">
            ...
            <p className="font-semibold text-gray-900">${cart.cartTotalAmount}</p>
          </div>
          <div className="flex items-center justify-between">
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          <p className="text-2xl font-semibold text-gray-900">${cart.cartTotalAmount + 8}</p>
        </div>
      </div>
