                ...
                <div className='grid grid-cols-1 md:grid-cols-12 border h-[40rem] bg-cover bg-center bg-black'>
                    <div className='bg-gray-800 md:col-span-4 p-10 text-white bg-cover bg-center h-[40rem]'>
                        ...
                        <p className='mt-4 leading-7 text-gray-200'>
                            Are you a retailer, influencer, or fashion
                            enthusiast looking to collaborate? We are open to
                            partnerships that align with our vision. Reach out
                            to us for wholesale inquiries, brand collaborations,
                            or any other business proposition.
                        </p>
