...
const Login = () => {
    ...
    return user && user.role ? (
        ...
        <div className='flex items-center min-h-screen bg-white text-primary-light dark:bg-primary-deepDark dark:text-primary-dark'>
            ...
            <div
                className={`flex hidden lg:flex lg:w-1/2 overflow-hidden h-screen bg-gradient-to-r from-cyan-500 to-blue-500 bg-no-repeat bg-center`}
            >
                <img className='w-full h-full object-cover' src="https://images.unsplash.com/photo-1485518882345-15568b007407?q=80&w=1484&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
            </div>
        </div>
    );
};
