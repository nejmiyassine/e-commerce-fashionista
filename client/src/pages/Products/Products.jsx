        ...
        <Layout>
            ...
            <div className='p-5'>
                <div className='flex flex-col md:flex-row md:justify-between md:items-center mb-6'>
                    <button onClick={() => setShowModel(true)} className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-2 md:mb-0'>
                        Add Product
                ...
                <table className='w-full bg-white border rounded-lg shadow-lg'>
                    ...
                    <tr>
                        <th className='px-4 py-3 text-left min-w-[150px]'>Product</th>
                        <th className='px-4 py-3 text-left min-w-[150px]'>Category</th>
                        <th className='px-4 py-3 text-left min-w-[150px]'>Price</th>
                        <th className='px-4 py-3 text-left min-w-[150px]'>Quantity</th>
                            ...
                            products
                                ...
                                .map((product) => (
                                    <tr className='hover:bg-gray-50' key={product._id}>
                                            ...
                                            <td className='px-4 py-3'>{product?.category_id.name ? product?.category_id.name : categories.find(cat => cat._id === product?.category_id)?.name}</td>
